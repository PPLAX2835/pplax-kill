...
public class MQConfig {
    ...
    @Bean("mqConnectionPPLAXKill")
    public Connection mqConnectionPPLAXKill(@Autowired MQConfigBean mqConfigBean) throws IOException, TimeoutException {
